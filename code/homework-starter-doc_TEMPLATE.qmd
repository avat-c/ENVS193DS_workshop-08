...
**Root mass (g) is strongly, positively correlated with total mass (Pearsons' r = 0.86). **  

**Shoot mass (g) is strongly, positively correlated with total mass (Pearsons' r = 0.9).**  

**Root mass (g) is strongly, positively correlated with shoot mass (Pearsons' r = 0.55)**
...
**Some species have higher avergae total biomass than others.Grindelia has highest average biomass and Acmispon has the lowest biomass. **
